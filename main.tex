...
Denote the set of trading strategies of risky assets as \[
    \cA \defn \set{\alpha = (\alpha_0, \dots, \alpha_{T-1}) : \alpha_t \in \cF_t, t=0, \dots, T-1}
\]

Hence if initial wealth \(V_0^\phi\) is known, every \(\alpha_t \in \cA\) can be complemented in a self-financing way.
